...
class Photos extends React.Component {
    ...
    loadPhotos() {
        ...
        let url =  'http://next-cheaply-tortoise.ngrok-free.app/api/photos/?limit='+limit+'&offset='+offset;
        fetch(url,{
                method:'GET',
                headers:{
    ...
    async uploadPhoto (file) {
        try {
            ...
            let response = await fetch('http://next-cheaply-tortoise.ngrok-free.app/api/photos/', {
                method:'POST',
                headers:{
                    'Authorization':token,
                },
